...
export default {
	...
	"annotationToolDescripton": "Make annotation tools available for assessment" //Description next to the checkbox for annotation tools when creating/editing an assignment
};
